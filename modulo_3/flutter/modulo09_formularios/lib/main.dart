...
class _Paso3State extends State<_Paso3> {
  final _servidores = [
    ServidorSSH(id:'1', nombre:'prod-web-01',servicio: 'Web Server',  ip:'10.0.2.10',   puerto:22,   usuario:'deploy',   so:'Ubuntu 24.04', ssl:true,  favorito:true),
    ServidorSSH(id:'2', nombre:'prod-db-01',servicio: 'Database Server',   ip:'10.0.2.20',   puerto:22,   usuario:'postgres', so:'Debian 12',    ssl:true),
    ServidorSSH(id:'3', nombre:'staging-api',servicio: 'Web Server',  ip:'10.0.3.10',   puerto:2222, usuario:'ubuntu',   so:'Ubuntu 24.04', ssl:false),
    ServidorSSH(id:'4', nombre:'dev-sandbox',servicio: 'Development Environment',  ip:'192.168.1.5', puerto:22,   usuario:'vagrant',  so:'Alpine Linux', ssl:false),
    ServidorSSH(id:'5', nombre:'ejem-001',servicio: 'Example Server',  ip:'192.168.1.5', puerto:22,   usuario:'vanguard',  so:' Linux', ssl:true),

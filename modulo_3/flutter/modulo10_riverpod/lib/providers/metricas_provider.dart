...
class MetricasNotifier extends AsyncNotifier<List<MetricaServidor>> {
  ...
  Future<List<MetricaServidor>> _fetch() async {
    ...
    return const [
      MetricaServidor(servidor:'prod-web-01', cpu:45.2, ram:62.1, conexiones:230, ssd:125.0),
      MetricaServidor(servidor:'prod-db-01',  cpu:88.1, ram:91.2, conexiones:80, ssd:125.5),
      MetricaServidor(servidor:'staging-api', cpu:22.4, ram:41.0, conexiones:50, ssd:256.5),
      MetricaServidor(servidor:'dev-db-api', cpu:12.0, ram:32.5, conexiones:10, ssd:256.0),

...
void main() => runApp(const ProviderScope(child: AppAdopcion()));
  ...
  Widget build(BuildContext context) {
    const pasos = [
      _PasoInfo(
        ...
        detalle: 'http.get() + FutureBuilder · requisito de adopción',
      ...
      _PasoInfo(
        ...
        detalle: 'RequisitoDto.fromJson · lista de requisitos',
      ...
      _PasoInfo(
        ...
        detalle: 'MascotaDto · toDomain() · API Platzi',
        icono: Icons.pets,
        color: Colors.orange,
      ),
      _PasoInfo(
      ...
      _PasoInfo(
        ...
        detalle: 'HttpClient · MascotasRepository · Riverpod Notifier',
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Módulo 12 — Adopción de Mascotas'),

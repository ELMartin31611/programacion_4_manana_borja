...
class PantallaPaso1 extends StatelessWidget {
  ...
  Future<Map<String, dynamic>> _fetchRequisito() async {
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('ID: ${requisito['id']}',
                      style: const TextStyle(fontSize: 14, color: Colors.grey)),
                  const SizedBox(height: 8),
                  Text(
                    requisito['title'] as String,
                  ...
                  Chip(
                    label: Text(
                      (requisito['completed'] as bool)
                          ? 'Cumplido ✓'
                          : 'Pendiente',
                    ),
                    backgroundColor: (requisito['completed'] as bool)
                        ? Colors.green[100]
                        : Colors.orange[100],
                  ),
                ],

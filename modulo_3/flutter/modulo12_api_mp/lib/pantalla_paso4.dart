...
class PantallaPaso4 extends StatelessWidget {
  ...
  Future<Result<List<Mascota>>> _fetchMascotas() async {
    try {
      ...
      final mascotas = lista
          .map((e) =>
              MascotaDto.fromJson(e as Map<String, dynamic>).toDomain())
          .toList();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<Result<List<Mascota>>>(
  ...
  Widget _buildLista(List<Mascota> mascotas) => ListView.builder(

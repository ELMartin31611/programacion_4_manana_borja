...
class Saludo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Text(
      'Lionel Messi marcó su primer triplete en un Mundial durante la victoria de Argentina 3-0 sobre Argelia en su debut en el torneo. Con estos tres goles, el capitán argentino alcanzó los 16 tantos en la Copa del Mundo, igualando a Miroslav Klose como máximo goleador histórico del certamen.',
      style: TextStyle(
        fontSize: 32,

...
void main() => runApp(const AppAdopcion());

class AppAdopcion extends StatefulWidget {
  const AppAdopcion({super.key});
  @override
  State<AppAdopcion> createState() => _AppAdopcionState();
}

class _AppAdopcionState extends State<AppAdopcion> {

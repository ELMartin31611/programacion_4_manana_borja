...
// │  3  Paso 3  queryParameters + extras + filtro vacunado         │
// │  4  Paso 4  ShellRoute + NavigationBar persistente              │
// │  5  Paso 5  Guard redirect + login + Riverpod                   │
// └──────────────────────────────────────────────────────────────────┘
const int paso = 3;

void main() => runApp(const ProviderScope(child: AppAdopcion(paso: paso)));

class AppAdopcion extends ConsumerWidget {
  final int paso;
  const AppAdopcion({super.key, required this.paso});
